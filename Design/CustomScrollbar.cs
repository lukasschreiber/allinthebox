...
namespace Design {
    ...
    public class CustomScrollbar : UserControl {
        ...
        [EditorBrowsable(EditorBrowsableState.Always), Browsable(true), DefaultValue(false), Category("Behavior"), Description("ExtraSmallChange")]
        public int ExtraSmallChange
        {
            get { return moExtraSmallChange; }
            set
            {
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            e.Graphics.FillRectangle(oWhiteBrush, new Rectangle(0, UpArrowImage.Height, 0, (this.Height - DownArrowImage.Height)));
            e.Graphics.FillRectangle(oWhiteBrush, new Rectangle(this.Width, UpArrowImage.Height, 0, (this.Height - DownArrowImage.Height)));
            ...
            float fSpanHeight = (fThumbHeight - (ThumbTopImage.Height + ThumbBottomImage.Height)) / 2.0f;
            int nSpanHeight = (int)fSpanHeight;//ThumbMiddleImage.Height + 
        ...
        private void CustomScrollbar_MouseDown(object sender, MouseEventArgs e) {
            mousedown = true; 
            ptPoint = this.PointToClient(Cursor.Position);
            int nTrackHeight = (this.Height - (UpArrowImage.Height + DownArrowImage.Height));
            float fThumbHeight = ((float)LargeChange / (float)Maximum) * nTrackHeight;
            int nThumbHeight = (int)fThumbHeight;
            ...
            Rectangle thumbrect = new Rectangle(new Point(1, nTop+1), new Size(ThumbMiddleImage.Width, nThumbHeight-1));
            ...
            Rectangle uparrowrect = new Rectangle(new Point(1, 0), new Size(UpArrowImage.Width, nTop));
            if (uparrowrect.Contains(ptPoint))
            {
                int ScrollUnit = SmallChange;

                Rectangle realuparrowrect = new Rectangle(1, 0, UpArrowImage.Width, UpArrowImage.Height);
            ...
            Rectangle downarrowrect = new Rectangle(new Point(1, UpArrowImage.Height + nTop), new Size(UpArrowImage.Width, UpArrowImage.Height + nTrackHeight));
            if (downarrowrect.Contains(ptPoint))
            {
                
                int ScrollUnit = SmallChange;
                Rectangle realdownarrowrect = new Rectangle(1, UpArrowImage.Height + nTrackHeight, UpArrowImage.Width, UpArrowImage.Height);
